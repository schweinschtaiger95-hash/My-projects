...
--
-- Name: elements element_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT element_name UNIQUE (name);


--
-- Name: elements element_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT element_symbol UNIQUE (symbol);
...
--
-- Name: elements_name_idx; Type: INDEX; Schema: public; Owner: freecodecamp
--

CREATE UNIQUE INDEX elements_name_idx ON public.elements USING btree (name);


--
-- Name: elements_symbol_idx; Type: INDEX; Schema: public; Owner: freecodecamp
--

CREATE UNIQUE INDEX elements_symbol_idx ON public.elements USING btree (symbol);
